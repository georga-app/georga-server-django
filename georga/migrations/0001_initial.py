# Generated by Django 4.1 on 2022-09-14 19:13
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('field', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='georga.taskfield')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('state', models.CharField(choices=[('DRAFT', 'draft'), ('PUBLISHED', 'published'), ('CANCELED', 'canceled'), ('DELETED', 'deleted'), ('DONE', 'done')], default='DRAFT', max_length=9)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('necessity', models.CharField(choices=[('RECOMMENDED', 'recommended'), ('MANDATORY', 'mandatory'), ('NOT_POSSIBLE', 'not possible')], default='RECOMMENDED', max_length=12, verbose_name='necessity')),
                ('organization', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='georga.organization')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='georga.locationcategory')),
                ('organization', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='georga.organization')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ace_string', models.CharField(choices=[('ADMIN', 'admin')], default='ADMIN', max_length=5)),
        ...
        migrations.AddIndex(
            model_name='ace',
            index=models.Index(fields=['access_object_ct', 'access_object_id'], name='georga_ace_access__88e18a_idx'),
        ),
