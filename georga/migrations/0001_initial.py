# Generated by Django 4.1 on 2022-09-15 04:06
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('state', django_fsm.FSMField(choices=[('DRAFT', 'Draft'), ('PUBLISHED', 'Published'), ('ARCHIVED', 'Archived'), ('DELETED', 'Deleted')], default='DRAFT', max_length=9)),
                ('email_delivery', django_fsm.FSMField(choices=[('NONE', 'None'), ('PENDING', 'Pending'), ('SENT', 'Sent'), ('SUCCEEDED', 'Succeeded'), ('FAILED', 'Failed')], default='NONE', max_length=9)),
                ...
                ('push_delivery', django_fsm.FSMField(choices=[('NONE', 'None'), ('PENDING', 'Pending'), ('SENT', 'Sent'), ('SUCCEEDED', 'Succeeded'), ('FAILED', 'Failed')], default='NONE', max_length=9)),
                ('sms_delivery', django_fsm.FSMField(choices=[('NONE', 'None'), ('PENDING', 'Pending'), ('SENT', 'Sent'), ('SUCCEEDED', 'Succeeded'), ('FAILED', 'Failed')], default='NONE', max_length=9)),
