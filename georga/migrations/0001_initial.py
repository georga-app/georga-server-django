# Generated by Django 4.1 on 2022-08-20 15:17
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('priority', models.CharField(choices=[('URGENT', 'Urgent'), ('IMPORTANT', 'Important'), ('NORMAL', 'Normal')], default='NORMAL', max_length=9)),
                ...
                ('delivery_state_email', models.CharField(choices=[('NONE', 'none'), ('PENDING', 'pending'), ('SENT', 'sent'), ('SENT_SUCCESSFULLY', 'sent successfully'), ('SENT_ERROR', 'sent error')], default='NONE', max_length=17)),
                ('delivery_state_push', models.CharField(choices=[('NONE', 'none'), ('PENDING', 'pending'), ('SENT', 'sent'), ('SENT_SUCCESSFULLY', 'sent successfully'), ('SENT_ERROR', 'sent error')], default='NONE', max_length=17)),
                ('delivery_state_sms', models.CharField(choices=[('NONE', 'none'), ('PENDING', 'pending'), ('SENT', 'sent'), ('SENT_SUCCESSFULLY', 'sent successfully'), ('SENT_ERROR', 'sent error')], default='NONE', max_length=17)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('access_object_ct', models.ForeignKey(limit_choices_to={'model__in': ['organization', 'project', 'operation']}, on_delete=django.db.models.deletion.CASCADE, to='contenttypes.contenttype')),
                ('person', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.AddField(
        ...
        migrations.AddIndex(
            model_name='acl',
            index=models.Index(fields=['access_object_ct', 'access_object_id'], name='georga_acl_access__1249e9_idx'),
        ),
    ]
