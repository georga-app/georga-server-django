...
class Person(AbstractUser):
    ...
    available_for_cleaning = models.CharField(
        max_length=11,
        choices=ANSWER_CLEANING,
        null=True,
        blank=True,
        verbose_name="Aufräumarbeiten nach Hochwasser",
    )
    ANSWER_TOPICS = [
        ('undefiniert', 'undefiniert'),
        ('unbedingt', 'unbedingt'),
    ...
    password1 = models.CharField(max_length=40, null=True, blank=True)
