# Generated by Django 4.2.11 on 2024-04-13 20:18
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('uuid', models.UUIDField(default=uuid.uuid4, editable=False, unique=True)),
                ('deleted', models.BooleanField(default=False)),
                ('state', django_fsm.FSMField(choices=[('DRAFT', 'Draft'), ('PUBLISHED', 'Published'), ('ARCHIVED', 'Archived'), ('DELETED', 'Deleted')], default='DRAFT', max_length=9, protected=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('state', django_fsm.FSMField(choices=[('DRAFT', 'Draft'), ('PUBLISHED', 'Published'), ('FINISHED', 'Finished'), ('CANCELED', 'Canceled'), ('ARCHIVED', 'Archived'), ('DELETED', 'Deleted')], default='DRAFT', max_length=9, protected=True)),
        ...
        migrations.CreateModel(
            ...
            options={
                'indexes': [models.Index(fields=['relation_object_ct', 'relation_object_id'], name='georga_pers_relatio_9fa2e9_idx')],
            },
        ),
        migrations.CreateModel(
            name='Participant',
            fields=[
                ...
                ('modified_at', models.DateTimeField(auto_now=True)),
                ('uuid', models.UUIDField(default=uuid.uuid4, editable=False, unique=True)),
                ('acceptance', django_fsm.FSMField(choices=[('ACCEPTED', 'Accepted'), ('DECLINED', 'Declined'), ('PENDING', 'Pending')], max_length=8, protected=True)),
                ('admin_acceptance', django_fsm.FSMField(blank=True, choices=[('ACCEPTED', 'Accepted'), ('DECLINED', 'Declined'), ('PENDING', 'Pending'), ('NONE', 'None')], default='PENDING', max_length=8, protected=True)),
                ...
                ('person', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('role', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='georga.role')),
                ('shift', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='georga.shift')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            options={
                'indexes': [models.Index(fields=['scope_ct', 'scope_id'], name='georga_mess_scope_c_0be525_idx')],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('state', django_fsm.FSMField(choices=[('DRAFT', 'Draft'), ('PUBLISHED', 'Published'), ('ARCHIVED', 'Archived'), ('DELETED', 'Deleted')], default='DRAFT', max_length=9, protected=True)),
                ('email_delivery', django_fsm.FSMField(choices=[('NONE', 'None'), ('SCHEDULED', 'Scheduled'), ('SENT', 'Sent'), ('SUCCEEDED', 'Succeeded'), ('FAILED', 'Failed')], default='NONE', max_length=9, protected=True)),
                ...
                ('push_delivery', django_fsm.FSMField(choices=[('NONE', 'None'), ('SCHEDULED', 'Scheduled'), ('SENT', 'Sent'), ('SUCCEEDED', 'Succeeded'), ('FAILED', 'Failed')], default='NONE', max_length=9, protected=True)),
                ('sms_delivery', django_fsm.FSMField(choices=[('NONE', 'None'), ('SCHEDULED', 'Scheduled'), ('SENT', 'Sent'), ('SUCCEEDED', 'Succeeded'), ('FAILED', 'Failed')], default='NONE', max_length=9, protected=True)),
            ...
            options={
                'indexes': [models.Index(fields=['scope_ct', 'scope_id'], name='georga_mess_scope_c_eb262d_idx')],
            },
        ),
        migrations.CreateModel(
            name='ACE',
            ...
            options={
                'indexes': [models.Index(fields=['instance_ct', 'instance_id'], name='georga_ace_instanc_eba447_idx')],
